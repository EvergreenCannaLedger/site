...
Exploring how CCRS data addresses (or fails to address) concerns raised by the Washington State Auditor in an October 22, 2024. Check out the [press release](https://sao.wa.gov/the-audit-connection-blog/states-cannabis-tracking-system-falls-short-long-sought-goals-audit-finds).
...
<br>
Some of the tables above were only snippets of the full dataset.  

[Feel free to reach out with any questions.](mailto:franklin@evergreencannaledger.org)
