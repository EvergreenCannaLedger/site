...
holiday_sales %>%
  ...
  scale_x_log10(labels = comma_format(), breaks = c(0, 100, 1000, 10000, 100000, 1000000, 10000000), limits = c(100, 10000000)) +
  scale_y_log10(labels = dollar_format(), breaks = c(100, 1000, 10000, 100000, 1000000, 10000000, 100000000), limits = c(100, 100000000)) +
  labs(
