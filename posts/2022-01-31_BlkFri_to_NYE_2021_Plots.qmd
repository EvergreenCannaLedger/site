---
title: "Black Friday 2021 to New Year’s 2022 in Washington’s CCRS Era"
subtitle: "A First Look at Sales Behavior at Year-End Holiday Season"
date: 2022-01-31
categories: [CCRS, Cannabis, Sales, Holiday]
tags: [CCRS, WSLCB, Cannabis, Sales, Holiday, Traceability, Market, Analysis]
format: html
editor: 
  markdown: 
    wrap: 72
...
## Revenue vs Units Sold by Type  
#See if which product types sell lots of units but earn less (or vice versa):
...
This answers questions like: 
  - Who sold the most usable cannabis? 
  - Which stores had the most revenue from pre-rolls?
...
sales_blackfriday_xmas_nye_2021 %>%
  ...
  scale_y_continuous(labels = dollar_format()) +
  labs(
    title = "Avg Revenue per Gram by Product Type",
    x = "Product Type",
    y = "Revenue per Gram ($)"
  ) +
  theme_minimal()
...
This identifies which products get discounted most
  - spot pricing pressure, clearance items, or strategic promotions.
...
This helps acknowledge: 
  - Who made the most money during Black Friday to New Year’s Day Period?
