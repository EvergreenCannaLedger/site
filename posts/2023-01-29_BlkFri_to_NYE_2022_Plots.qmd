---
title: "Black Friday 2022 to New Year’s Day 2023 in Washington’s CCRS Era"
subtitle: "Another Look at Sales Behavior at Year-End Holiday Season"
date: "2023-01-29"
categories: [CCRS, Cannabis, Discount, Sales, Holiday]
tags: [CCRS, cannabis, discount, sales, washington, market, analysis]
format: html
fig-height: 4.5
fig-width: 6
toc: true
...
| **Total Revenue**                 | ≈ $798 thousand                            |
| **Top Product Category**          | Useable Cannabis ($366K, 46%) |
| **Number of Reporting Licensees** | ~60                                       |
| **Peak Sales Day**                | December 22, 2022                         |
| **Peak Category Share**           | Useable Cannabis: 46% of total sales          |
...
Useable Cannabis and Concentrates for Inhalation absolutely dominated with nearly half of total holiday sales. Traditional usable cannabis (flower) and concentrate for inhalation led at $366 thousand and $200K, respectively, in sales, while edibles (solid and liquid combined) made up 1% of overall sales.
...
During the holiday window, Transdermals, Non-solvent based and CO₂ concentrates fetched the highest prices per gram, reflecting niche medical and artisanal segments.  The price stratification shows a clear tiering of Washington’s cannabis economy — from everyday flower under $6/gram to boutique topicals and extracts exceeding $30-80/gram.
...
kable(caption = "Average Discount % by Product Type (Discount > 4%") %>%
kable_styling(full_width = FALSE, bootstrap_options = c("striped", "hover"))
...
Discounting varied widely across product categories. While tinctures, non-solvent concentrates, topical ointments, and edibles saw double-digit markdowns, from flower to ethanol concentrates — the main revenue driver — showed single digit discount percentages on average.
...
kable(caption = "Total Revenue per Licensee – Holiday Season 2022 (Revenue > $10,000)") %>%
kable_styling(full_width = FALSE, bootstrap_options = c("striped", "hover"))
...
The top 10 licensees accounted for nearly 85% of total sales, led by Lucid, Free Rain Farms, Origins, and Green Lady.
